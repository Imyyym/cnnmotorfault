...
for _ in range(train_shuliang):
    ...
    for i in range(gene_num - 1):
        if random.random() < mutate_prob_b:
            ...
            for jj in range(index2_mutate - index1_mutate ):#aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
